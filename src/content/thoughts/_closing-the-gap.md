...
image:
  {
    url: "/src/images/content/closing-the-gap.svg",
    alt: "Red text quote with yellow background",
  }
---
...
Honestly, I think it’s just the nature client work. Or more maybe more specifically, doing client work _alone_.
...
I think with any new thing there’s inevitably going to be a learning curve. You’re just not going to be good at it on your first, second, or even seventeenth try. But you’ll be <i>incrementally better</i>.
...
So I guess I shouldn’t say that I’m not good enough. I’m just not where I want to be yet. I saw [this video](https://vimeo.com/85040589) a few years ago about the gap between your abilities and your taste, and I’ve just been in that space for a while.

### How am I closing the gap?

A few months ago, I spoke to a friend of mine who was more or less in a similar space. (Reason #1 why you need community.) He recommended that I join [Recurse Center](https://www.recurse.com/). Basically, it’s a self-guided retreat — virtual or IRL — for programmers to explore their interests, with no bounds or deadlines.
...
But honestly, I just had to realize that I’m downplaying my work and my experience by only focusing on where I feel I lack. The best way to get better, is to learn generously, and the best place to do that _is_ Recurse.
...
In the last two-ish weeks, I’ve felt waves of excitement, intimidation, whimsy, overwhelm, and overwhelming <i>support</i>. It’s been really beautiful and eye-opening. I’ve met plenty of people who are in the same boat as I am. Starting from zero in some way, deeply interested in building skills in some area, worried about our own contributions to this experience, and even a bit worried about the job market when we get out.
