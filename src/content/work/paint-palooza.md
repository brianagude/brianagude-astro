...
title: "Paint Palooza"
pubDate: 2026-07-15
description: "A Windows 98-style desktop environment with apps built to explore historical color spaces."
url: "https://paint-palooza.pages.dev/"
image:
  {
...
First up is a paint app modeled after Windows 95 Paint, but built to let you switch color spaces and watch the same color shift in real time across different historical perspectives. (Still in progress)
